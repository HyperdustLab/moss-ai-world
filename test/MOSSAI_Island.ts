...
describe('MOSSAI_Island', () => {
  describe('MOSSAI_Island', () => {
    it('MOSSAI_Island', async () => {
      ...
      await (await Island_Mint.setContractAddress([MOSSAI_Island.target, Hyperdust_Wallet_Account.target, Hyperdust_Transaction_Cfg.target, MOSSAI_Token.target, MOSSAI_Island_NFG.target, Hyperdust_Roles_Cfg.target])).wait()
      ...
      await (await MOSSAI_Island.setContractAddress([MOSSAI_Island_NFG.target, MOSSAI_Island_Map.target, Island721Factory.target, Island1155Factory.target, Hyperdust_Roles_Cfg.target, '0x0000000000000000000000000000000000000000', MOSSAI_Island_Data.target, Island_Mint.target])).wait()
