...
async function main() {
    ...
    await (await contract.setContractAddress(["0x311ff1729cd41cfc4236df28cF30FcaD32e67D6e", '0x6C34AbF4632BC38e90f5016d784D3ED320Cfad14', '0x66a0dcFF2803124F506d4a8F6D5Fa813629B8Bfa'])).wait()
